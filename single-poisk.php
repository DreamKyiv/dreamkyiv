...
div.row.row-meta {display:none;}
		...
		<div class="row">
			<div class="col-sm-11" style="padding-top:20px;">
				<p> За допомогою цієї сторінки ви зможете дізнатись, хто з депутатів представляє Ваші інтереси в Київраді, знайти його контактні дані, та детальну інформацію про його діяльність.</p>
			</div>
		</div>
		<div class="row">
			<div class="col-sm-12">
